...
- **[Public Right-of-Way]({{ site.baseurl }}prowag/)**. Guidelines for access to sidewalks, pedestrian street crossings, pedestrian signals, shared use paths, and other components of public right-of-way.
...
Many training sessions are held at the request of, or in partnership with, organizations or groups holding conferences and seminars that include accessibility of persons with disabilities on the agenda. The Board also has a conference space at its offices in Washington, D.C. that is sometimes used for trainings.
