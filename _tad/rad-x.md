...
<div class="grid-container">
  <div class="grid-row">
    ...
    <div class="tablet:grid-col"> <img class="img-medium" src="../images/Text-Perception.jpg" alt="Folded instruction sheet illustration."> <span class="grid-line text-italic">Instructions for use</span> </div>
  </div>
</div>
<div class="grid-container">
  <div class="grid-row">
