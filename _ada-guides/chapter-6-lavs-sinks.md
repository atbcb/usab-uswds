...
![A classroom lab with individual sink stations, including sinks and work surfaces with forward approach access. ]({{ site.baseurl }}{{ page.image-directory }}chapter6/drinking-fountains/1.png){: .img-large}
