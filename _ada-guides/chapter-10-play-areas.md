...
![Illustration of an elevated play component]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/1.jpg){: .img-large"}
...
rocker]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/13.jpg){: .img-left}
...
<table class="usa-table">
    <thead>
        <tr>
            <td>Number of elevated play components provided</td>
            <td>Minimum number of ground-level play components required to be on accessible route</td>
            <td>Minimum number of different types of ground-level play components required to be on accessible route</td>
        </tr>
    </thead>
    <tbody>
        <tr>
...
| ![photo of a play area with protective shelters and benches offset from the boundary of the accessible route]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/31.jpg) |
...
![photo of a bermed accessible route]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/32.jpg)Berms are sometimes used to provide access to elevated play areas. A berm may be a natural sloped surface that is present in a hilly play area site, or a ground-level route built with slopes.
...
![photo of composite structure with accessible surfacing made of recycled rubber ]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/34.jpg)
...
| ![photo of play area with accessible and inaccessible surfaces]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/35.jpg) |
| ![photo of 2 slides with one connected by an accessible route and the other by inaccessible surfacing (sand)]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/36.jpg) |
...
| ![photo of train ride with accessible surfacing designed to appear like train tracks]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/38.jpg) |
...
![photo of elevated route]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/40.jpg)\
...
![photo of a play area with more than 20 play components]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/42.jpg)
...
**Landings**
![photo of a girl using a wheelchair at the top of play structure's ramp ]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/44.jpg)**
...
![photo of boy using a wheelchair descending ramp with handrails on both sides]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/45.jpg)
...
**Transfer Steps**![photo of transfer system with shallow steps]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/51.jpg)**\
...
| ![photo of supports at transfer steps]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/52.jpg) |

![photo of butterfly-shaped spring rocker with supports]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/54.jpg)

 |

> > > **A****esthetically pleasing cutout shapes and other design enhancements can provide hand supports for transferring. ****Materials in a variety of different shapes and sizes are used to manufacture transfer supports including metal, plastic, and rope.**
> > >
...
>
>\
> ![isometric drawing of composite play structure with elevated play components, transfer platform, steps, and support]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/55.jpg)Consideration must be given to the distance between the transfer system and the elevated play components it is intended to facilitate. Designers should minimize the distance between the points where a child transfers from a wheelchair or mobility device and the elevated play destination.\
>\
...
**Connected Elevated Components![photo of children using a tunnel play space]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/57.jpg)**
...
**Clear Floor or Ground Space![plan view of clear floor space 30 inches (760 mm) wide and 48 inches (1220 mm) long]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/part5.1.gif)\
...
| ![photo of landing area on composite structure and elevated window activity]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/58.jpg) |
...
-   Slope not steeper than 1:48 in all directions
    ...
    | ![plan view of a turning circle with a 60 inch (1525 mm) diameter]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/60.jpg) |   | ![plan view of t-turn space where each segment is at least 60 inches (1525 mm) long and 36 inches (915 mm) wide]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/61.jpg) |
...
![photo of a girl in a crawl tube opening]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/64.jpg)**Entry Points and Seats**\
...
-   17 inches (430 mm) deep minimum![photo of a boy on a spring rocker that is equipped with a hand support]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/65.jpg)\
...
Reach ranges should be considered when providing play components with manipulative or interactive features for children who use wheelchairs. Recommended forward or side reach ranges are:![photo of children at play table]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/68.jpg)

-   20 to 36 inches for 3 to 4 year-olds
-   18 to 40 inches for 5 to 8 year-olds
-   16 to 44 inches for 9 to 12 year-olds

| ![Illustration of high and low side reaches of girl using wheelchair ]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/70.jpg) |   | ![illustration of high and low forward reaches of boy using a wheelchair]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/71.jpg) |
| **Side Reach** |   | **Forward Reach** |

![photo of a boy using a wheelchair at an interactive panel]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/72.jpg)The reach ranges appropriate for use by children who use wheelchairs to access play components are intended for ground-level components, and elevated components accessed by ramps. Reach ranges are not appropriate for play components reached by transfer systems. Appropriate reach range heights will vary depending on how the play component is accessed.  This interactive panel (right) is mounted at a height appropriate for a child who uses a wheelchair.
...
![Illustration of a soft contained play structure with several entry and exit points]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/73.jpg)\
![Photo of a transfer system at the entry of a soft contained play structure]({{ site.baseurl }}{{ page.image-directory }}chapter10/play-guide/74.jpg)
