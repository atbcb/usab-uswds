...
Liabilities not covered by budgetary resources are liabilities that are not funded by any current appropriation or other funding source. These liabilities consist of accrued annual leave, deferred rent, and actuarial FECA. Deferred rent is the difference at year-end between the sum of monthly cash disbursements paid to date for rent and the sum of the average monthly rent calculated based 
