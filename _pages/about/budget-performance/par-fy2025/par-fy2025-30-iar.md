...
-   no material weaknesses in internal control over financial reporting based on the limited procedures[^3], we performed; and 
...
The following sections discuss in more detail (1) our report on the financial statements, which includes a 
section on required supplementary information (RSI)[^4] and a section on other information included with 
the financial statements[^5]; (2) our report on internal control over financial reporting; and (3) our report on 
